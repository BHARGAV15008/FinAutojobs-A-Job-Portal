                ...
                <Button
                  ...
                  sx={{
                    ...
                    '&:hover': {
                      ...
                      ...(button.gradient && {
                        background: button.gradient.replace('667eea', '5a67d8').replace('764ba2', '6b46c1'),
                      }),
                    },
                    '&:active': {
                ...
                <Card
                  ...
                  sx={{
                    ...
                    boxShadow: activeCard === index
                      ? `0 20px 40px rgba(${card.color === '#667eea' ? '102, 126, 234' : card.color === '#764ba2' ? '118, 75, 162' : '74, 222, 128'}, 0.3)`
                  ...
                  <CardContent sx={{ p: 4, textAlign: 'center' }}>
                    <Box
                      sx={{
                        ...
                        transform: activeCard === index ? 'scale(1.1) rotate(5deg)' : 'scale(1) rotate(0deg)',
                      }}
                    >
