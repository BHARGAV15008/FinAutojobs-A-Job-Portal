...
const ProfessionalApplicantDashboard = () => {
    ...
    const JobRecommendationCard = ({ job }) => (
        <div className="bg-white/70 backdrop-blur-sm rounded-2xl border border-white/20 hover:border-blue-200 hover:shadow-xl hover:bg-white/80 transition-all duration-300 hover:-translate-y-1 p-6">
            <div className="flex items-start justify-between mb-4">
                ...
                <div className={`px-2 py-1 rounded-lg text-xs font-medium ${getMatchColor(job.match_score)}`}>
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
            {/* Notification */}
            {notification && (
                <div className={`fixed top-4 right-4 z-50 px-6 py-3 rounded-xl shadow-xl backdrop-blur-sm transition-all duration-300 ${
                    notification.type === 'success' ? 'bg-emerald-500/90 text-white border border-emerald-400' : 'bg-red-500/90 text-white border border-red-400'
                }`}>
            ...
            <div className="flex h-screen">
                {/* Sidebar */}
                <div className={`bg-white/80 backdrop-blur-sm border-r border-blue-100 shadow-lg transition-all duration-300 ${
                    ...
                    <div className="h-16 flex items-center justify-between px-4 border-b border-blue-100">
                        {!sidebarCollapsed && (
                            <div className="flex items-center space-x-2">
                                ...
                                <span className="text-xl font-bold bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">FinAutoJobs</span>
                            </div>
                        )}
                        <button
                    ...
                    <nav className="flex-1 px-3 py-4 space-y-1">
                        {[
                            ...
                            { id: 'career', name: 'Career Insights', icon: TrendingUp }
                        ].map((item) => {
                        ...
                        <div className="flex items-center justify-between">
                            <div>
                                <h1 className="text-2xl font-bold text-gray-900">
                                    ...
                                    {activeTab === 'recommendations' && 'Job Recommendations'}
                        ...
                        {activeTab === 'jobs' && (
                            <div className="space-y-6">
                                ...
                                <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl border border-blue-200 p-6">
                                    ...
                                    <p className="text-gray-600 text-sm">
                                        Find your perfect job with AI-powered matching and advanced filters.
                                    </p>
                                </div>
                                ...
                                <div className="bg-white rounded-xl border border-gray-200 p-6">
                                    ...
                                    <div className="flex flex-wrap gap-2 mb-4">
                                        ...
                                        {['Remote', 'High Salary', 'Startup', 'Fortune 500', 'AI/ML', 'React'].map((filter) => (
                                            <button key={filter} className="px-3 py-1 bg-gray-100 text-gray-700 rounded-full text-sm hover:bg-blue-100 hover:text-blue-700 transition-colors">
                                                {filter}
                                            </button>
                                        ))}
                                    </div>
                                    ...
                                    <div className="flex items-center justify-between">
                                        <div className="flex items-center space-x-4">
                                            ...
                                            <label className="flex items-center space-x-2">
                                                <input type="checkbox" className="rounded border-gray-300 text-blue-600 focus:ring-blue-500" />
                                                <span className="text-sm text-gray-700">AI Match 80%+</span>
                                            </label>
                                        </div>
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                                    ...
                                    <div className="lg:col-span-2 space-y-6">
                                        {/* Career Progress */}
                                        <div className="bg-white rounded-xl border border-gray-200 p-6">
                                            <h4 className="text-lg font-semibold text-gray-900 mb-4">Career Progress Analysis</h4>
                                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                                                <div className="bg-blue-50 rounded-lg p-4">
                                                    <div className="flex items-center justify-between mb-2">
                                                        <span className="text-sm text-blue-600 font-medium">Market Position</span>
                                                        <Target className="w-4 h-4 text-blue-600" />
                                                    </div>
                                                    <div className="text-2xl font-bold text-blue-700 mb-1">Top 15%</div>
                                                    <p className="text-xs text-blue-600">Among React developers</p>
                                                </div>
                                                ...
                                                <div className="bg-purple-50 rounded-lg p-4">
                                                    <div className="flex items-center justify-between mb-2">
                                                        <span className="text-sm text-purple-600 font-medium">Career Score</span>
                                                        <Award className="w-4 h-4 text-purple-600" />
                                                    </div>
                                                    <div className="text-2xl font-bold text-purple-700 mb-1">8.7/10</div>
                                            ...
                                            <div className="mb-4">
                                                ...
                                                <div className="h-32 bg-gray-50 rounded-lg flex items-end justify-between p-4">
                                                    {[65, 72, 68, 78, 85, 82, 88, 92, 87, 94, 96, 98].map((value, index) => (
                                                        <div key={index} className="flex flex-col items-center">
                                                            <div 
                                                                className="bg-gradient-to-t from-blue-600 to-blue-400 rounded-t w-3" 
                                                                style={{ height: `${value}%` }}
                                                            ></div>
                                        ...
                                        {/* AI Recommendations */}
                                        <div className="bg-white rounded-xl border border-gray-200 p-6">
                                            <h4 className="text-lg font-semibold text-gray-900 mb-4">AI Career Recommendations</h4>
                                            <div className="space-y-4">
                                                {[
                                                    {
                                                        type: 'skill',
                                                        ...
                                                        description: 'Adding TypeScript to your skillset could increase your match rate by 34% and salary potential by $15k',
                                                    ...
                                                    },
                                                    {
                                                        ...
                                                        description: 'Your experience level qualifies you for 23 senior positions with 40% higher salaries',
                                                        action: 'View Roles',
                                                        icon: TrendingUp,
                                                        color: 'blue'
                                                    },
                                                    {
                                                        ...
                                                        description: 'Connect with 5 more professionals in your field to increase referral opportunities',
                                        ...
                                        {/* Market Trends */}
                                        <div className="bg-white rounded-xl border border-gray-200 p-6">
                                            <h4 className="text-lg font-semibold text-gray-900 mb-4">Market Trends & Insights</h4>
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                                <div>
                                                    <h5 className="font-semibold text-gray-900 mb-3">Hot Skills in Your Field</h5>
                                                    <div className="space-y-2">
                                                        {[
                                                            { skill: 'TypeScript', growth: '+45%', demand: 'Very High' },
                                                            { skill: 'Next.js', growth: '+38%', demand: 'High' },
                                                            { skill: 'GraphQL', growth: '+32%', demand: 'High' },
                                                            { skill: 'Docker', growth: '+28%', demand: 'Medium' }
                                                        ].map((trend, index) => (
                                                            <div key={index} className="flex items-center justify-between p-2 bg-gray-50 rounded">
                                                                <span className="text-sm font-medium text-gray-900">{trend.skill}</span>
                                                                <div className="flex items-center space-x-2">
                                                ...
                                                <div>
                                                    <h5 className="font-semibold text-gray-900 mb-3">Salary Insights</h5>
                                                    <div className="space-y-3">
                                                        <div className="p-3 bg-green-50 rounded-lg">
                                                            <div className="flex items-center justify-between mb-1">
                                                                <span className="text-sm font-medium text-gray-900">Your Range</span>
                                                                <span className="text-sm font-bold text-green-700">$85k - $120k</span>
                                                            </div>
                                                            <p className="text-xs text-gray-600">Based on your skills and experience</p>
                                                        </div>
                                                        <div className="p-3 bg-blue-50 rounded-lg">
                                                            ...
                                                            <p className="text-xs text-gray-600">For React developers in your area</p>
                                                        </div>
                                                        <div className="p-3 bg-purple-50 rounded-lg">
                                                            <div className="flex items-center justify-between mb-1">
                                                                <span className="text-sm font-medium text-gray-900">Growth Potential</span>
                                                                <span className="text-sm font-bold text-purple-700">+$25k</span>
                                                            </div>
                                                            <p className="text-xs text-gray-600">With recommended skills</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div className="space-y-6">
                                        {/* Career Health Score */}
                                        <div className="bg-white rounded-xl border border-gray-200 p-6">
                                            <h4 className="text-lg font-semibold text-gray-900 mb-4">Career Health</h4>
                                            <div className="text-center mb-4">
                                                <div className="relative w-24 h-24 mx-auto">
                                                    <svg className="w-24 h-24 transform -rotate-90" viewBox="0 0 100 100">
                                                        <circle cx="50" cy="50" r="40" stroke="#e5e7eb" strokeWidth="8" fill="none" />
                                                        <circle cx="50" cy="50" r="40" stroke="#10b981" strokeWidth="8" fill="none" 
                                                                strokeDasharray={`${87 * 2.51} 251`} strokeLinecap="round" />
                                                    </svg>
                                                    <div className="absolute inset-0 flex items-center justify-center">
                                                        <span className="text-2xl font-bold text-gray-900">87</span>
                                                    </div>
                                                </div>
                                                <p className="text-sm text-gray-600 mt-2">Excellent health score</p>
                                            </div>
                                            <div className="space-y-3">
                                                {[
                                                    { label: 'Profile Completeness', value: 95, color: 'green' },
                                                    { label: 'Skill Relevance', value: 88, color: 'blue' },
                                                    { label: 'Market Alignment', value: 82, color: 'purple' },
                                                    { label: 'Network Strength', value: 76, color: 'orange' }
                                                ].map((metric, index) => (
                                                    <div key={index}>
                                                        <div className="flex items-center justify-between mb-1">
                                                        ...
                                                        <div className="w-full bg-gray-200 rounded-full h-1.5">
                                                            <div className={`bg-${metric.color}-600 h-1.5 rounded-full`} style={{ width: `${metric.value}%` }}></div>
                                                        </div>
                                                    </div>
                                                ))}
                                            </div>
                                        ...
                                        {/* Learning Path */}
                                        <div className="bg-white rounded-xl border border-gray-200 p-6">
                                            <h4 className="text-lg font-semibold text-gray-900 mb-4">Recommended Learning Path</h4>
                                            <div className="space-y-3">
                                                {[
                                                    { skill: 'TypeScript', progress: 0, duration: '2 weeks', priority: 'high' },
                                                    { skill: 'Next.js', progress: 30, duration: '3 weeks', priority: 'medium' },
                                                    { skill: 'GraphQL', progress: 0, duration: '2 weeks', priority: 'medium' },
                                                    { skill: 'Testing (Jest)', progress: 60, duration: '1 week', priority: 'low' }
                                                ].map((path, index) => (
                                                    <div key={index} className="border border-gray-200 rounded-lg p-3">
                                                        <div className="flex items-center justify-between mb-2">
                                                            <span className="text-sm font-medium text-gray-900">{path.skill}</span>
                                                        ...
                                                        <div className="w-full bg-gray-200 rounded-full h-1.5 mb-1">
                                                            <div className="bg-blue-600 h-1.5 rounded-full" style={{ width: `${path.progress}%` }}></div>
                                                        </div>
                                                        <p className="text-xs text-gray-600">{path.duration} estimated</p>
                                                    </div>
                                                ))}
                                            </div>
                                        </div>
                                        ...
                                        {/* Industry News */}
                                        <div className="bg-white rounded-xl border border-gray-200 p-6">
                                            <h4 className="text-lg font-semibold text-gray-900 mb-4">Industry News</h4>
                                            <div className="space-y-3">
                                                {[
                                                    {
                                                        title: 'React 19 Released',
                                                        summary: 'New features and performance improvements',
                                                        time: '2 hours ago',
                                                        category: 'Technology'
                                                    },
                                                    {
                                                        title: 'Remote Work Trends 2024',
                                                        summary: 'Latest insights on remote job market',
                                                        time: '1 day ago',
                                                        category: 'Career'
                                                    },
                                                    {
                                                    ...
                                                    <div key={index} className="border-b border-gray-100 pb-3 last:border-b-0">
                                                        <h5 className="text-sm font-medium text-gray-900 mb-1">{news.title}</h5>
            ...
            {showAIChat && (
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
                    <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl h-[600px] flex flex-col">
                        <div className="flex items-center justify-between p-6 border-b border-gray-200">
                            <div className="flex items-center space-x-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-gray-600">Your personal job search companion</p>
                                </div>
                            </div>
                            <button
                        ...
                        <div className="flex-1 overflow-auto p-6" ref={chatMessagesRef}>
                            <div className="space-y-4">
                        ...
                        <div className="border-t border-gray-200 p-4">
                            <div className="flex space-x-2">
                                <input
                                    ...
                                    placeholder="Ask me about jobs, career advice, or application tips..."
...
export default ProfessionalApplicantDashboard;      