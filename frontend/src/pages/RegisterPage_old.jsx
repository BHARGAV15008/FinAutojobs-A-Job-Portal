...
export default RegisterPage
              ...
              <div className="grid grid-cols-2 gap-3">
                <button
                  ...
                  className={`p-4 border-2 rounded-md text-center transition-colors ${
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  value={formData.firstName}
                  onChange={handleChange}
                  className={`w-full px-3 py-3 border rounded-md focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent ${
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  value={formData.email}
                  onChange={handleChange}
                  className={`w-full pl-10 pr-4 py-3 border rounded-md focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent ${
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  value={formData.password}
                  onChange={handleChange}
                  className={`w-full pl-10 pr-12 py-3 border rounded-md focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent ${
