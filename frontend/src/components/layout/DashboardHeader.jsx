                    ...
                    <div className="py-1">
                      <button
                        ...
                        style={{ 
                          ...
                          color: darkMode ? '#ffffff !important' : '#374151'
                        }}
                      >
                        <div className="flex items-center">
                          <svg
                            ...
                            stroke="currentColor"
                            viewBox="0 0 24 24"
                            style={{ color: darkMode ? '#ffffff !important' : '#374151' }}
                          >
                            <path
                              strokeLinecap="round"
                              strokeLinejoin="round"
                          ...
                          <span style={{ color: darkMode ? '#ffffff !important' : '#374151' }}>
                            Your Profile
                          </span>
                        </div>
                      </button>
                      ...
                      <button
                        ...
                        style={{ 
                          fontFamily: 'Inter, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif',
                          color: darkMode ? '#f87171 !important' : '#dc2626'
                        }}
                      >
                        <div className="flex items-center">
                          <svg
                            ...
                            stroke="currentColor"
                            viewBox="0 0 24 24"
                            style={{ color: darkMode ? '#f87171 !important' : '#dc2626' }}
                          >
                            <path
                              strokeLinecap="round"
                              strokeLinejoin="round"
                          ...
                          <span style={{ color: darkMode ? '#f87171 !important' : '#dc2626' }}>
                            Sign out
                          </span>
                        </div>
                      </button>
