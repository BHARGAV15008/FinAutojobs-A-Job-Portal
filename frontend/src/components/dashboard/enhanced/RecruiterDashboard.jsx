  ...
  const [messages, setMessages] = useState([
    {
      ...
      message: 'Thank you for scheduling the interview. I look forward to discussing the position...',
      time: '2 hours ago',
      unread: true,
      avatar: 'JD'
    },
    {
      ...
      message: 'I wanted to follow up on my application for the Full Stack Engineer position...',
      time: '5 hours ago',
      unread: false,
      avatar: 'JS'
    }
      ...
      <DashboardCard title="Quick Actions" icon={Plus}>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <button className="flex flex-col items-center p-4 bg-green-50 dark:bg-green-900/20 rounded-lg hover:bg-green-100 dark:hover:bg-green-900/30 transition-colors">
            ...
            <span className="text-sm font-medium text-gray-700 dark:text-gray-300">View Applicants</span>
          </button>
