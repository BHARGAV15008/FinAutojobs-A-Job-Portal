...
const CandidateProfileModal = ({
  ...
  useEffect(() => {
    ...
    const fetchCandidateDetails = async () => {
      ...
      try {
        console.log(
          "🔍 Fetching detailed data for candidate:",
        ...
        if (candidateId) {
          ...
          for (const endpoint of endpoints) {
            try {
              ...
              if (response.data) {
                ...
                console.log(
                  "✅ Successfully fetched detailed candidate data:",
                  detailedData
                );
                break;
              }
          ...
          if (detailedData) {
            ...
            const mergedData = {
              ...
              name:
                candidate.name ||
                detailedData.fullName ||
                detailedData.firstName + " " + detailedData.lastName,
              ...
              expectedSalary:
                ...
                detailedData.expectedSalary ||
                detailedData.salary ||
                "Not specified",
              experience:
                candidate.experience ||
                detailedData.experience ||
                detailedData.yearsOfExperience ||
                "Not specified",
              currentRole:
                candidate.currentRole ||
                candidate.currentJobTitle ||
                detailedData.currentRole ||
                detailedData.currentJobTitle ||
              ...
              summary:
                ...
                detailedData.bio ||
                detailedData.professionalSummary ||
                "No summary provided",
              qualification:
                candidate.qualification ||
                detailedData.qualification ||
                detailedData.highestQualification ||
                "Not specified",
              skills:
                candidate.skills && candidate.skills.length > 0
                  ? candidate.skills
                  : detailedData.skills || detailedData.technicalSkills || [],
              workExperience:
                candidate.workExperience && candidate.workExperience.length > 0
                  ? candidate.workExperience
                  : detailedData.workExperience ||
                    detailedData.experience ||
                    [],
              education:
                candidate.education && candidate.education.length > 0
                  ...
                  : detailedData.education ||
                    detailedData.educationHistory ||
                    [],
              portfolioLinks:
                candidate.portfolioLinks && candidate.portfolioLinks.length > 0
                  ? candidate.portfolioLinks
                  : detailedData.portfolioLinks || detailedData.links || [],
              resume:
                candidate.resumeUrl ||
                detailedData.resume ||
                detailedData.resumeUrl ||
                candidate.resume,
            ...
            const enhancedCandidate = {
              ...
              summary:
                candidate.summary || candidate.bio || "No summary provided",
              currentRole:
                candidate.currentRole ||
                candidate.currentJobTitle ||
                "Not specified",
  ...
  console.log(
    "🔍 Display candidate appliedDate:",
    displayCandidate.appliedDate
  );
      ...
      <div className="fixed inset-0 z-50 overflow-y-auto">
        ...
        <div className="flex min-h-full items-center justify-center p-2 sm:p-4">
          <motion.div
            ...
            className={`relative w-full max-w-[95vw] sm:max-w-3xl md:max-w-4xl lg:max-w-5xl xl:max-w-6xl rounded-lg shadow-2xl max-h-[95vh] overflow-hidden ${
          ...
          >
            {/* Header */}
            <div
              className={`px-3 sm:px-6 lg:px-8 py-4 sm:py-6 border-b ${
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    >
                      {displayCandidate.currentRole ||
                        displayCandidate.currentJobTitle ||
                        "Not specified"}
                    </p>
                      ...
                      <div>
                        ...
                        <span
                          className={`inline-block px-2 py-1 rounded-full text-xs font-medium ml-2 ${
                            displayCandidate.status === "active"
                              ? "bg-green-100 text-green-800"
                              : displayCandidate.status === "interested"
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="space-y-3">
                      {(Array.isArray(candidate.portfolioLinks)
                        ? candidate.portfolioLinks
                        : [
                            {
                              type: "LinkedIn",
                            ...
                            {
                              type: "Portfolio",
                              url: "https://candidate-portfolio.com",
