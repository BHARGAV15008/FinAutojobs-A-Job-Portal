...
const ResumeBuilderPage = React.lazy(() =>
  import("../pages/ResumeBuilderPage").catch(() => ({
  ...
  return (
    ...
    >
      ...
      {!isDashboard && !isAuthPage && (
        <Box
          component="footer"
          sx={{ bgcolor: "grey.900", color: "white", py: 1.5, mt: "auto" }}
        >
          <Box
          ...
          >
            ...
            >
              <Box>
                ...
                <Box
                  component="p"
                  sx={{ color: "grey.400", mb: 0.5, fontSize: "0.875rem" }}
                >
              ...
              <Box>
                ...
                <Box
                  component="ul"
                  sx={{ listStyle: "none", p: 0, "& li": { mb: 0.25 } }}
                >
                  <li>
                    <Box
                      component="a"
