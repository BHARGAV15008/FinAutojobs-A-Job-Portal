...
const sampleCompanies = [
  ...
  },
  {
    ...
    description: 'Innovative startup building next-generation AI and ML solutions.',
  ...
  },
  {
    ...
    description: 'Digital banking and financial services platform serving millions of customers.',
  ...
  },
  {
    ...
    description: 'Healthcare technology company revolutionizing patient care with digital solutions.',
  ...
  },
  {
    ...
    description: 'AI-powered data analytics and business intelligence platform.',
    industry: 'Software Product',
    size: '51-200',
    location: {
      city: 'Delhi NCR',
  ...
  try {
    ...
    if (existingCount > 0) {
      const answer = await new Promise((resolve) => {
        ...
        readline.question('Companies already exist. Clear all and reseed? (yes/no): ', (answer) => {
          readline.close();
    ...
    result.forEach((company, index) => {
      console.log(`${index + 1}. ${company.name} - ${company.industry} (${company.size}) - ${company.location.city}`);
    });
