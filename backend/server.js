...
try {
  ...
  console.error(
    "⚠️  Failed to connect to MongoDB. Server will start in limited mode."
  );
  console.error(
    "⚠️  Some features requiring database access will not be available."
  );
  console.error("⚠️  Email and API endpoints will still work for testing.");
}
...
console.log("🔄 Registering /api/communications routes...");
apiRouter.use("/communications", communicationsRoutes);
console.log(
  "✅ /api/communications routes registered successfully - Email/SMS communication enabled!"
);
