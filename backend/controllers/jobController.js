...
export const getJobById = async (req, res) => {
  try {
    ...
    const job = await Job.findById(id)
      .populate(
        "postedBy",
        "firstName lastName company.name company.logo company.description"
      )
      .populate({
        path: "applications",
  ...
  try {
    ...
    const jobData = {
      ...
      company: {
        ...
        description:
          req.user.company?.description || req.body.company?.description,
      },
      status: "active",
      createdAt: new Date(),
      updatedAt: new Date(),
    ...
    await job.populate(
      "postedBy",
      "firstName lastName company.name company.logo"
    );
