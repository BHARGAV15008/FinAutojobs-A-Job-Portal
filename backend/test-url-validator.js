...
const testUrls = {
  linkedin_url: 'http://localhost:3000/applicant-dashboard/profile',
  github_url: 'http://localhost:3000/applicant-dashboard/profile1',
  portfolio_url: 'http://localhost:3000/applicant-dashboard/profile2'
};
...
console.log('localhost:3000 valid?', isValidExternalUrl('http://localhost:3000/test'));
